var GHOST = '&#9760';
// var GHOST='&#128520';
var GHOSTS = ['<img class="pacman" src="img/1.png">', '<img class="pacman" src="img/2.png">', '<img class="pacman" src="img/3.png">']
...
function changeGhostColor(changeColor) {
...
function rndGhost() {
    var rndIndex = rndNum(0, 2);
    return GHOSTS[rndIndex];
}
